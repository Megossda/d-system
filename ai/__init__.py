...
from spells.level_1.level_1 import searing_smite, guiding_bolt, cure_wounds
...
class GiantConstrictorSnakeAI(AIBrain):
    ...
    def choose_actions(self, character, combatants):
        ...
        if target:
            ...
            if character.is_grappling and character.grapple_target and character.grapple_target.is_alive:
